 ...
 *
 * <p>Holds the {@link
 * com.lyanhkhoa.linksentry.analysis.normalization.UrlNormalizer} contract and its
 * implementation. Exercises 1–3 of {@code docs/MANUAL_IMPLEMENTATION_GUIDE.md}
 * cover validation, the normalised model, then registrable-domain extraction.
 *
